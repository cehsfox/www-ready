...
/* This is a variation of the original "gsendmail.php".
 * This script handles file uploading, and sends uploaded file as email
 * attachment.
 */

/* UNLV Libraries, web form emailing script.
 * Developer: Hong Zhang
 * $Id: fsendmail.php, v 2.0 $
 */
 ...
 *      # If return_address exists, then it recieves copy in Cc: address.
 *
 ...
 *        copy and paste.
 *
 * 2006-10-11: Hong Zhang
 *      # Started porting to "fsendmail.php".
 *
...
define ("USERFILE", 'userfile');    // Form input field name for upload file.
...
$referer_blocked = array (
    ...
    "http://www.library.nevada.edu/php/fsendmail.php",
    "http://library.nevada.edu/php/fsendmail.php",
...
$mime_boundary_html = $mime_boundary . "_htmlalt";


$headers = "MIME-Version: 1.0\n" .
        "Content-Type: multipart/mixed; boundary=\"$mime_boundary\"\n";

    // Prepare message text/html body.
$finalmsg =
        "--" . "$mime_boundary\n" .
        "Content-Type: multipart/alternative; boundary=\"$mime_boundary_html\"\r\n\r\n" .
        "--" . "$mime_boundary_html\n" .
...
// >> Added 2006-10-11 by Hong Zhang
    // Extract all uploaded files and embed into message.
$tmpmsg = '';
if ( is_array ($_FILES[USERFILE]["error"]) )
{
    foreach ( $_FILES[USERFILE]["error"] as $key => $error )
    {
        if ( UPLOAD_ERR_OK === $error )
        {
            ...
            // The file name that server assigned to the file.
            $tmpname = $_FILES[USERFILE]["tmp_name"][$key];
            $data = file_get_contents ($tmpname);

            // Embed file content into email message body.
            $tmpmsg .=
                "--" . "$mime_boundary\n" .
...
//$headers = "From: hong.zhang@unlv.edu\n" . $headers;
//mail ("hong.zhang@unlv.edu", $subject, $mymsgbody, $headers);
